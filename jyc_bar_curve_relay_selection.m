function  [t,location_relay,n_relay,relay_main,relay,num_vehi,location_vehi,n_re_relay,PDR,last_t]=jyc_bar_curve_relay_selection(location_vehi_in_Rp,location_vehi,n_relay,R,Linmap1m,num_vehi,location_relay,N_iter,N_part,A,relay,t,posi_opt,n_re_relay,locationmark,ima2,send_end,old_sender,old_posi_opt)
...
%          hold on
         ...
         relay_main = relay;
         if N_part==4
             [delay_one_hop_mini_average,PDR] = jyc_log_partition (location_vehi_in_Rp,density_EM,N_iter,N_part,CW_CTB,sender,posi_opt,relay);
             t = t + delay_one_hop_mini_average;
             last_t = delay_one_hop_mini_average;
         else
             [delay_one_hop_average,PDR] = jyc_3P3B_delay_calcu (location_vehi_in_Rp,density_EM,N_iter,N_part,CW_CTB,sender,posi_opt,relay);
