function  [t,location_relay,n_relay,n_jucntion,relay_main,relay,range]=jyc_straight_relay_selection(location_vehi,junction,n_jucntion,n_relay,locationmark,R,Linmap1m,num_vehi,location_relay,N_iter,N_part,A,relay_main,t,posi_opt)
